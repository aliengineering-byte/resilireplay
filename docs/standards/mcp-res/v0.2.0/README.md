...
1. evidence semantics and false-green elimination;
2. authenticity, independent validation, and migration;
3. protocol, async, transport, and official-conformance attachment;

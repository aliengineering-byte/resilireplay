...
The six protocol/async/transport/cache/extension v1 manifests below are **PROVISIONAL**. The OAuth and future-identity manifests are documented separately in [AUTHORIZATION.md](AUTHORIZATION.md) and [FUTURE_IDENTITY.md](FUTURE_IDENTITY.md). They describe bounded, reason-bound reliability observations for named released MCP revisions and extensions. They are not official MCP profiles, interoperability certification, security certification, or evidence of independent adoption.

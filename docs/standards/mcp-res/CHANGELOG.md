...
- PR 5 ([#54](https://github.com/aliengineering-byte/resilireplay/pull/54)): added the provisional operational profile and 18-fault taxonomy, bounded runtime workload evidence, a four-subject Windows/Linux field corpus, inert-reader safety limits, a machine profile registry, implementer/governance material, and scheduled source-drift observation.

...
- PR 2: separated integrity/authenticity/trust, added offline Ed25519 DSSE/in-toto-informed attestations, reproducible SBOM/provenance packaging, a dependency-free Python validator, and deterministic non-promoting v0.1 migration.
